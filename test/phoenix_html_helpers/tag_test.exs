defmodule PhoenixHTMLHelpers.TagTest do
  use ExUnit.Case, async: true

  import Phoenix.HTML
  import PhoenixHTMLHelpers.Tag
  doctest PhoenixHTMLHelpers.Tag
  ...
  describe "csrf_token_value" do
    ...
    test "with configured MFA" do
      default_reader = Application.fetch_env!(:phoenix_html_helpers, :csrf_token_reader)
      ...
      after
        Application.put_env(:phoenix_html_helpers, :csrf_token_reader, default_reader)
      end
    end
  end
end
